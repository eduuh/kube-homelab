...
| Name | Role | IP Address | CPU | Memory | OS Image | Status |
|------|------|------------|-----|--------|----------|--------|
| `talos-o1t-vd9` | **Control Plane** | `10.0.0.24` | 16 | 13GB | Talos (v1.11.5) | Ready |
| `talos-ly2-g4y` | Worker | `10.0.0.35` | 4 | 16GB | Talos (v1.11.5) | Ready |
| `talos-nst-2ck` | Worker | `10.0.0.4` | 4 | 6GB | Talos (v1.11.5) | Ready |
